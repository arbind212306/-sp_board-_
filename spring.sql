...
insert into `add_sessions` (`id`,`joinee_id`,`user_id`,`business_unit_id`,`department_id`,`sub_department_id`,`note`,`session_date`,`start_time`,`end_time`,`time_created`,`time_modified`,`is_accepted`,`status`) values (25,55,1,1,1,7,'Note for Baren given for Aditya Jain given','2018-09-26','01:00:00','03:00:00','2018-09-13 07:32:41','2018-09-13 07:32:57',0,0);
...
insert into `feedbacks` (`id`,`title`,`interval_days`,`description`,`for_joinee`,`for_supervisor`,`status`,`list_type`) values (1,'Feedback 15 Days',15,'Desc',1,1,0,NULL);
...
insert into `feedbacks` (`id`,`title`,`interval_days`,`description`,`for_joinee`,`for_supervisor`,`status`,`list_type`) values (5,'45 Days checklist',45,'45 Days Checklist Description',0,1,1,NULL);
...
CREATE TABLE `logistics` (
  ...
  `time_created` datetime DEFAULT NULL,
  `time_modified` datetime DEFAULT NULL,
  `dept_manager_emailid` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

/*Data for the table `logistics` */

insert into `logistics` (`id`,`title`,`description`,`business_unit_id`,`location_id`,`department_id`,`sub_department_id`,`status`,`time_created`,`time_modified`,`dept_manager_emailid`) values (1,'LAN Id Creation','Description of LAN ID Creation',1,1,1,7,1,'0000-00-00 00:00:00',NULL,'');
insert into `logistics` (`id`,`title`,`description`,`business_unit_id`,`location_id`,`department_id`,`sub_department_id`,`status`,`time_created`,`time_modified`,`dept_manager_emailid`) values (2,'Business Card','Description of business Card providing',2,2,2,9,1,'0000-00-00 00:00:00',NULL,'');
insert into `logistics` (`id`,`title`,`description`,`business_unit_id`,`location_id`,`department_id`,`sub_department_id`,`status`,`time_created`,`time_modified`,`dept_manager_emailid`) values (3,'Voice Support','Description for Voice Support in Gurgaon',3,3,3,15,1,'0000-00-00 00:00:00','2018-09-07 06:30:48','');
insert into `logistics` (`id`,`title`,`description`,`business_unit_id`,`location_id`,`department_id`,`sub_department_id`,`status`,`time_created`,`time_modified`,`dept_manager_emailid`) values (4,'Car Parking Sticker','Description of Car Parking Sticker',1,4,4,23,1,'0000-00-00 00:00:00',NULL,'');
insert into `logistics` (`id`,`title`,`description`,`business_unit_id`,`location_id`,`department_id`,`sub_department_id`,`status`,`time_created`,`time_modified`,`dept_manager_emailid`) values (5,'Access Card/Photo ID card','This logistic arrangements for  Access Card/Photo ID card in gurgaon plot -119',1,3,1,7,0,'2018-09-05 07:48:22','2018-09-07 06:25:55','');
insert into `logistics` (`id`,`title`,`description`,`business_unit_id`,`location_id`,`department_id`,`sub_department_id`,`status`,`time_created`,`time_modified`,`dept_manager_emailid`) values (6,'System request','This is System request for Gurgaon plot -119.',1,3,3,NULL,1,'2018-09-05 07:50:09',NULL,'');
insert into `logistics` (`id`,`title`,`description`,`business_unit_id`,`location_id`,`department_id`,`sub_department_id`,`status`,`time_created`,`time_modified`,`dept_manager_emailid`) values (7,'Desktop Configuration','Description for desktop configuration',4,2,50,91,1,'2018-09-07 06:32:22',NULL,'');
insert into `logistics` (`id`,`title`,`description`,`business_unit_id`,`location_id`,`department_id`,`sub_department_id`,`status`,`time_created`,`time_modified`,`dept_manager_emailid`) values (8,'Wheels ','This is wheels department.',1,3,1,7,1,'2018-09-13 07:51:36','2018-09-13 08:00:34','wheels@quatrro.com');
...
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (125,63,'1',0,'2018-09-13 08:21:43',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (126,63,'2',0,'2018-09-13 08:21:43',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (127,63,'4',0,'2018-09-13 08:21:43',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (128,62,'4',0,'2018-09-13 08:22:33',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (129,62,'8',0,'2018-09-13 08:22:33',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (130,63,'6',0,'2018-09-13 08:23:05',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (131,63,'8',0,'2018-09-13 08:23:05',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (132,34,'7',0,'2018-09-13 08:24:53',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (133,34,'8',0,'2018-09-13 08:24:53',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (134,48,'7',0,'2018-09-13 08:25:15',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (135,48,'8',0,'2018-09-13 08:25:15',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (136,59,'2',0,'2018-09-13 09:33:18',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (137,59,'6',0,'2018-09-13 09:33:18',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (138,59,'7',0,'2018-09-13 09:33:18',NULL);
insert into `logistics_arrangement` (`id`,`user_id`,`logistic_id`,`r_status`,`time_created`,`logistic_arrangement_add_by`) values (139,59,'8',0,'2018-09-13 09:33:18',NULL);
...
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (2,4,'employee','$2y$10$rqJO1MDMvMHcHQYmvKFTderWnGm9FJ.HUr684eD3BhUdcjmwwl/D2','QGS-002','Akshay','Jain','2018-08-11','akshay.jain836@gmail.com','9784789956','Delhi',NULL,'Viyatnam','3','2','7','PHP Developer','B4','QGS-025','QUA96358','2018-08-11 00:00:00','2018-09-06 12:16:15',NULL,1,'Manual',NULL,1,'Amit Kumar','amit.kumar@quatrro.com','Rakesh Kumar','rakesh.kumar@quatrro.com');
...
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (48,4,'Abhishek','$2y$10$nxFik0qoDrlHP8e5yuF5OunjAGshDbnQW48b97kMF/yyOy5J.XYW.','QUA021R','Abhishek','Gupta','2018-09-10','abhishek@gmail.com','','Delhi',NULL,'USA','1','4','95','Developer','2','QGS-002','QMA0024','2018-07-09 13:25:30','2018-09-10 13:25:30',NULL,2,'Manual',NULL,1,'Sanjeev','Sanjeev@gmail.com','Shiv','shiv@gmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (54,4,'Rajiv','$2y$10$kNt8xVE6wwNTFxOFZ.0wB.BlHYSCAgYf/2CNlNOqd95hZo8WT.vhW','QUA021R','Rajiv','','2018-09-10','rajiv1@gmail.com','pass','Thane',NULL,'India','2','80','','Developer','1','QGS-002','QMA0024','2018-08-09 13:38:47','2018-09-11 06:02:41',NULL,2,'Manual',NULL,1,'Sanjeev','Sanjeev@gmail.com','Shiv','shiv@gmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (55,4,'Baren','$2y$10$mdTpalVq37uNpgWPew1Q2OYX7FVrlxPbavja41TUbb.SobCDTXqSi','QUA021R','Baren','','2018-09-10','baren@gmail.com','','Thane',NULL,'USA','2','42','76','Developer','2','QGS-002','QMA0024','2018-08-07 13:42:13','2018-09-10 13:42:13',NULL,1,'Manual',NULL,1,'Sanjeev','Sanjeev@gmail.com','Shiv','shiv@gmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (58,4,'Rahul','$2y$10$irR5d6762PP1pkudWNYie.U5sbfkMBhGZisrLUGSan5GpLiFzKq4e','QPS001','Rahul','','2018-09-13','rahul@gmail.com','9337180770','Delhi',NULL,'India','2','29','53','Developer','4','QRS0012','QMS005','2018-08-13 06:01:12','2018-09-13 06:46:11',NULL,2,'Manual',NULL,1,'Sanjeev','sanjeev@gmail.com','Rajat','rajat@gnmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (59,4,'sourabh','$2y$10$bDe9js3EZDsxtSxQBJxFk.oerJLQhMyW954FmD2PGXsEpOnqwgxCO','QUA021R','Sourabh','','2018-09-13','sourabh@gmail.com','8090025343','Delhi',NULL,'India','3','31','69','Developer','2','QTA0247','QMA0024','2018-09-01 06:02:28','2018-09-13 06:46:39',NULL,2,'Manual',NULL,1,'Sanjeev','Sanjeev@gmail.com','Shiv','shiv@gmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (60,4,'Ashish','$2y$10$EXIiVRj/UurbQ.olpjt6AO1Fzi1ZINbtVsywGqn1MkjkCUp8E5mmq','QUA021R','Ashish','','2018-09-13','ashish@gmail.com','8090025343','Thane',NULL,'India','3','82','','Developer','1','QTA0247','QMA0024','2018-09-03 06:03:53','2018-09-13 06:46:44',NULL,3,'Manual',NULL,1,'Sanjeev','Sanjeev@gmail.com','Shiv','shiv@gmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (61,4,'Amrish','$2y$10$/xl35fFVP6H80s/mKnu6XunEeUzXsGySqIEzmPOPHiexQDgZUR8M.','QUA021R','Amrish','','2018-09-13','amrish@gmail.com','9337180770','Delhi',NULL,'India','2','42','76','Developer','2','QTA0247','QMA0024','2018-09-03 06:06:06','2018-09-13 06:47:09',NULL,3,'Manual',NULL,1,'Sanjeev','Sanjeev@gmail.com','Shiv','shiv@gmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (62,4,'Ankit','$2y$10$IfklUbTWkCndBH8kIIgfW.r6wXivlMtKuVRZ4MEV328wRKfBa.sIy','QUA021R','Ankit','','2018-09-13','ankit@gmail.com','9337180770','Chennai',NULL,'India','2','80','','Developer','5','QTA0247','QMA0024','2018-09-08 06:07:15','2018-09-13 06:07:15',NULL,1,'Manual',NULL,1,'Sanjeev','Sanjeev@gmail.com','Shiv','shiv@gmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (63,4,'Akash','$2y$10$bYE3VTVpHtlo2d4w1HAftuBL/Ng1Z0lsuySyJYbfEvvxDzrDDYs2q','QUA021R','Akash','','2018-09-13','akash@gmail.com','8090025343','Thane',NULL,'India','2','80','','Developer','7','QTA0247','QMA0024','0000-00-00 00:00:00','2018-09-13 06:08:13',NULL,1,'Manual',NULL,1,'Sanjeev','Sanjeev@gmail.com','Shiv','shiv@gmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (64,4,'Ranjeet','$2y$10$/9rpjAwjXZgM8KvfpcJ9O.RGgWEbuPGb6WizpPIYt8V9yw9OfE/iu','QUA021R','Ranjeet','','2018-09-13','ranjeet@gmail.com','8090025343','Delhi',NULL,'India','3','31','69','Developer','6','QTA0247','QMA0024','2018-09-10 06:09:28','2018-09-13 06:09:28',NULL,1,'Manual',NULL,1,'Sanjeev','Sanjeev@gmail.com','Shiv','shiv@gmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (65,4,'Rinku','$2y$10$MI0ElKO2W0R0myNSvzZgfuGKegLXoSBb5VBabXPsajIw85qyUhtle','QUA021R','Rinku','','2018-09-13','rinku@gmail.com','8090025343','Chennai',NULL,'India','3','43','79','Developer','2','QTA0247','QMA0024','2018-09-12 06:14:52','2018-09-13 06:47:14',NULL,2,'Manual',NULL,1,'Sanjeev','Sanjeev@gmail.com','Shiv','shiv@gmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (66,4,'Tom','$2y$10$1MwevaeYhn0JYqzIHSzu1u98osgbSuTsHzxfSh0Fh5yOqaSRCe2Oq','QUA021R','Tom','','2018-09-13','tom@gmail.com','8090025343','Thane',NULL,'Viyatnam','3','32','66','Engineer','2','QTA0247','QRP003','2018-09-12 06:17:36','2018-09-13 06:17:36',NULL,1,'Manual',NULL,1,'jorge','jorge@gmail.com','Smith','smith@gmail.com');
insert into `users` (`id`,`user_type`,`username`,`password`,`emp_id`,`first_name`,`last_name`,`doj`,`email`,`mobile`,`city`,`state`,`country`,`businees_unit`,`department`,`sub_department`,`designation`,`band`,`manager_emp_id`,`bhr_emp_id`,`created`,`modified`,`last_login`,`status`,`auth_type`,`supervisor_name`,`ob_status`,`manager_name`,`manager_email`,`bhr_name`,`bhr_email`) values (67,4,'Tim','$2y$10$abGHEMZzoHz8FEpTnvoOMevzhVke0u9GoVlEmcKSa4G/3KjCHIFeu','QUA021R','Tim','','2018-09-13','tim@gmail.com','9337180770','Delhi',NULL,'Viyatnam','4','50','91','Developer','2','QTA0247','QMA0024','2018-09-12 06:34:26','2018-09-13 06:47:21',NULL,2,'Manual',NULL,1,'Bond','bond@gmail.com','David','david@gmail.com');
